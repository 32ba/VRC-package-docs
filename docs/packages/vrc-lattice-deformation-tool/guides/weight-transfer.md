...
1. **Stage 1 の初期転写**：変形後の各頂点について、元メッシュの近い頂点からボーンウェイトをコピーします。距離や法線角度の条件に合わない頂点は次の段階に回されます。
2. **Stage 2 のウェイト補間**：Stage 1 で転写できなかった頂点のウェイトを、周囲の頂点から滑らかに補完します。メッシュの形状に沿った自然なウェイト分布が生成されます。
