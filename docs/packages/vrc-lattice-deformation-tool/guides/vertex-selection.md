...
{/* TODO: オーバーレイのモード切替部分。 <Icon name="brush" /> ブラシ と <Icon name="vertex-select" /> 頂点選択 のタブが見えるスクリーンショット */}
...
{/* TODO: 頂点選択ツールで複数頂点が選択された状態のスクリーンショット。黄色 (選択) と青色 (未選択) の頂点、移動ハンドルが見える状態 */}
...
{/* TODO: プロポーショナル編集が有効な状態のスクリーンショット。緑色の影響半径が表示されている様子 */}
